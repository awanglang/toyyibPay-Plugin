            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-toyyibpay" class="form-horizontal">
					...
					<div class="form-group required">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="toyyibpay_api_key_value" value="<?php echo $toyyibpay_api_key_value; ?>" placeholder="<?php echo $toyyibpay_api_key; ?>" id="input-api-key" class="form-control" />
