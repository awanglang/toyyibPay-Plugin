...
$_['text_toyyibpay'] = '<a onclick="window.open(\'http://www.toyyibpay.com/\');" style="text-decoration:none;"><img src="view/image/payment/logo.png" alt="ToyyibPay" title="ToyyibPay. Fair Payment Software" style="border: 0px solid #EEEEEE;" height=25 width=94/></a>';
