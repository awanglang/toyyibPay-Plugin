            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-toyyibpay" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="toyyibpay_category_code_value" value="<?php echo $toyyibpay_category_code_value; ?>" placeholder="<?php echo $toyyibpay_category_code; ?>" id="input-vkey" class="form-control" />
                        </div>
                    </div>
